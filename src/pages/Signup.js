...
import { createUser, errorRemove, googleLogin } from "../features/auth/authSlice";
...
const Signup = () => {
  ...
  const { error, isError, user: { email }, isLoading } = useSelector(state => state.auth);
          ...
          <form onSubmit={handleSubmit(onSubmit)}>
            <div className='space-y-3'>
              ...
              <button onClick={handleGoogleSignUp}
                className='font-semibold text-white bg-blue-400 py-3 rounded-full border w-full'
              >
                Sign Up With Google
              </button>
            </div>
